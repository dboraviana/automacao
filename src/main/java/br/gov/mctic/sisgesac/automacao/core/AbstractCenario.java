...
public abstract class AbstractCenario extends AbstractPageObject{
    ...
    protected void acessarMenu(String... menus) {	
     ...
     protected void aguardarCarregamento() {
        WDS.delay(500);
        WDS.getWait().until(ExpectedConditions.invisibilityOf(WDS.get().findElement(By.cssSelector(".ngc-carregando"))));
        WDS.delay(500);
    }
